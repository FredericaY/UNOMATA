...
- Follow-up: aiming animation and gun direction still have offsets. The user will address them in a separate new change; the old IK record remains historical reference.
...
- 后续事项：瞄准动画和枪口方向仍有偏差，将单独新建 change；旧 IK 记录保留为历史参考，不当作已完成。
